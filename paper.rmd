...
national and international acts coming into force to protect individual rights to privacy[\@GDPR; \@CalCiv2018].  

One effect of increase legislation and visibility of privacy concerns has been a surge in data literacy,  with
data controllers becoming more aware of the risks associated with the data they hold[ref].  Of all concerns, 'personal
identifiability' i.e. the ability to directly or indirectly identify an individual from a dataset[ref], is paramount 
and, if breeched, can lead to reputation damage and fines[ref]. Where data is structured and  complete, a manual inspection 
...
to aid in this process.  The most notable of these are the `PII` package[ref], which is designed to 
