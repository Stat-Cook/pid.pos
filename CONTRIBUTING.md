...
reports: please file a minimal reproducible example on GitHub. - Feature
requests: please open an issue on GitHub outlining the feature you would
like to see, and ideally a use case for it. - Implemented features: if
you are thinking of expanding the package with a new feature, please
open an issue first to discuss the design principles and ensure it is
compatible with the overall aims of the package.
